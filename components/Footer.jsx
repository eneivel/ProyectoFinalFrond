        ...
        <div className="container">
          <div className="footer-top">
            ...
            <div className="footer-reseña">
              ...
              <p>
                La Trattoria del Chef es mucho más que un restaurante; es una
                experiencia culinaria que te transportará a las auténticas
                tradiciones italianas. Nuestro apasionado equipo de chefs
                combina los sabores más exquisitos con ingredientes frescos y de
                alta calidad para ofrecerte pizzas que deleitarán tu paladar.
              </p>
            </div>
          </div>
