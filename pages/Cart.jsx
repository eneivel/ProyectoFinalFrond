...
export default function Cart() {
  ...
  const { carro, total, SubtractPizza, AddPizza, FormatCoin } =
    ...
    <div className="container p-5 bg-light">
      ...
      <div className="products-total">
        <h1 className="text-center">
          Carro de Compras <i className="fas fa-shopping-cart"></i>
        </h1>
        <div>
                ...
                return (
                  <tr key={item.id}>
                    <th scope="row" className="align-middle">
                      <img src={pizza.img} className="img-cart" alt="Pizza" />{" "}
                      {pizza.titulo}
                    </th>
                    <th className="text-center fs-4 align-middle">
                      {FormatCoin(totalPrice)}
                    </th>
                    <td className="align-middle">
                      <button
                        className="btn btn-sm btn-danger"
                        onClick={() => SubtractPizza(item.id)}
                      >
                        -
                      </button>
